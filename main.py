...
st.markdown("<h1 style='text-align: center; color: black;'>Chào mừng bạn đến với chương trình chữ ký số nhóm dựa trên danh tính EC-ID-MuSig</h1>", unsafe_allow_html=True)
